...
function Banner() {
  return (
    <div className="bg-banner h-[700px] bg-cover shadow-insetcustom flex items-center justify-center  ">
      <div className="text-center container mx-auto my-auto ">
        ...
        <button className=" px-4 py-2 border-green-500 text-green-600 font-semibold   border rounded-full items-center justify-center">
          Learn more
        </button>
      </div>
    </div>
