          ...
          <div className="">
            {SliderData.map((item, index) => (
              ...
              >
                ...
                />
                <div className="w-[500px] bg-white border border-gray-500 relative p-10 top-[-350px] ">
                  <p className="text-[18px] text-left font-bold py-2">DESIGN</p>
                  <h1 className="text-3xl text-gray-800 font-semibold text-left">
                  ...
                  <p className="text-[18px] text-gray-400 font-semibold  text-left">
